        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="login.html"><i class="fa fa-sign-out fa-fw"></i> Вихід</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="tables.html"><i class="fa fa-table fa-fw"></i> Каса</a>
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="#"><i class="fa fa-clipboard"></i> Список поствок</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-user" aria-hidden="true"></i> Поставщики</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
             <li>
                <a href="tables.html"><i class="fa fa-envelope fa-fw"></i> Повідомлення</a>
            </li>
               <li>
